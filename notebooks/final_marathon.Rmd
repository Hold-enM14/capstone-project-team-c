...
## Figure 3: Overview of the Relationship Between Air Quality and Finishing Time by Marathon (ZD)
```{r}
...
Create XGboost model containing the engineered features, binned features, and scaled features: (ZD)
```{r}
...
knitr::kable(
  comparison_table,
  digits = 4,
  caption = "Comparison of XGBoost Raw-Feature vs Engineered-Feature Models (Updated)"
)
...
# Model Interpretation & Feature Analysis (MH / ZD)

## Feature Importance: Gain, Cover & Frequency (MH)
...
## Feature Interactions by Subgroup & Gender (MH / ZD)
